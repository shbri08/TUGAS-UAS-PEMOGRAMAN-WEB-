<?php
  ...
  $koneksi = mysqli_connect('localhost', 'root', '', 'sharerecipes');
  ...
  function addRecipe( $data )
  {
    ...
    // jalankan query
    mysqli_query($koneksi, "INSERT INTO recipes VALUES (NULL, '$title' ,'$user_id', '$category_id', '$materials', '$procedures', 1,'$thumbnail')");
